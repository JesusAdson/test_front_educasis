					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto text-end float-end ms-auto">
								...
								<router-link to="/add-salary" class="btn btn-primary"><i class="fas fa-plus"></i></router-link>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
							...
							<div class="card card-table">
								<div class="card-body">
									<div class="table-responsive">
										<table class="table table-hover table-center mb-0 datatable" id="salarytable">
											<thead>
												<tr>
													<th>ID</th>
													<th>Name</th>
...
<script>
import salary from '../../../../assets/json/salary.json';
